...
export function LoginPageContent({ hideLoginOptions, isLoggingIn, children }: Props) {
  ...
  }, [discordLoginError, clearError, showMessage]);
  ...
  const subtitle = customDomain === null && (
    ...
    >
       We are committed to fostering a culture where learning is continuous, accessible, and transformative
    </Typography>
  );
  ...
  const title = spaceFromPath ? (
    ...
    <>
      Building solutions that makes education <br />
